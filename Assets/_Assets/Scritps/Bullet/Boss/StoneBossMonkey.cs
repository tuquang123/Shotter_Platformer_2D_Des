...
public class StoneBossMonkey : BaseBullet
{
    ...
    public override void Deactive()
    {
        ...
        audioSource.Stop();
        PoolingController.Instance.poolStoneBossMonkey.Store(this);
    }

    protected override void SpawnHitEffect()
    {
        EffectController.Instance.SpawnParticleEffect(EffectObjectName.StoneBrokenMedium, transform.position);
