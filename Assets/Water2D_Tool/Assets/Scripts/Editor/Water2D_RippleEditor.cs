                ...
                InspectorBox(10, () =>
                {
                    ...
                    if (water2D_Ripple.ambientWaves)
                    {
                        ...
                        if (water2D_Ripple.amplitudeZAxisFade)
                            water2D_Ripple.amplitudeFallOff = EditorGUILayout.Slider(new GUIContent("Amplitude Fade Distance", "Controls the amplitude fade along the Z axis."), water2D_Ripple.amplitudeFallOff, 0, 0.99f);
